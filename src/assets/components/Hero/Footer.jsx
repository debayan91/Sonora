...
const FHero = () => {
  ...
  return (
    <div>
      ...
      <div id="bottomnav" className='px-10 h-[100%] text-white text-center font-100 bg-transparent backdrop-blur-sm flex flex-col justify-center items-center text-[19px] gap-[20px] tracking-[0.25em] font-roboto'>
      <hr className='w-[80%] border-1 mt-5 border-white'></hr>
          <div className='h-[calc(40vh-17vh)] flex flex-row justify-center items-center text-[19px] gap-14 tracking-[0.25em] font-roboto'>
            ...
            <a href="/contact" id="a5">Contact</a>
            </div>
            <br></br>
